...
const { MkCalendarXml, PropFindXml, ReportXml } = require('./xmldata');
...
class CalDAV {
  /**
   * Creates CalDAV client with base URL and optional authentication info.
   *
   ...
   */
  report(path, filter) {
    let xml = new ReportXml(filter).toXml();
